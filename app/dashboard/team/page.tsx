...
const SCOPE_CATALOG: Record<TeamOrg["platformAccess"][number], Array<{ scope: string; label: string }>> = {
  ...
  survey_studio: [
    ...
    { scope: "survey_studio:survey.quality.read", label: "View response quality" },
    { scope: "survey_studio:survey.quality.review", label: "Review response quality" },
    { scope: "survey_studio:survey.quality.configure", label: "Configure response quality" },
    { scope: "survey_studio:survey.quality.export", label: "Export response quality" },
    { scope: "survey_studio:survey.quality.export.detailed", label: "Export detailed quality evidence" },
